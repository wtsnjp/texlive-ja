...
\item Jonathan Kew．優れた\TeX エンジンである\XeTeX を開発し，時間と労力を割いてその
  処理系を\TL に導入してくれました．彼はさらに初期バージョンのMac\TeX を開発し，我々の
...
新しい\GUI フロントエンド{\TeX}worksがWindowsとMac\TeX 向けに追加されました．
...
\TL ベースのディストリビューション{Mac\TeX}（\ref{sec:macos}節）は，今後Latin
...
Mac\TeX: CJKサポートGhostscriptパッケージの更新が反映されました．システム環境
...
Mac\TeX: システム環境設定の``\TeX\ Distribution''ペインが廃止され，そこで
