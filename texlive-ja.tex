...
\item \cs{mathdefaultsmode}の規定ラジカルスタイルが変更されました．
...
\item \cs{pdfinterwordspaceon}下において，現在のフォントエンコーディングが
  ...
  \code{/space}には（新規の）規定フォント\code{pdftexspace}が用いられます．この規定
  フォントは新プリミティブ\cs{pdfspacefont}によって上書きすることが可能です．
