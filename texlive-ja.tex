...
%\end{alltt}
%
%This tells \cmd{tlmgr} to use a nearby \CTAN\ mirror for future updates.
...
%
%To facilitate this, when the \pkg{xetex} package is installed
...
%\cmd{mktexlsr} or use the `Reinit file database' button on the
